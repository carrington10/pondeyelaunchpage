"""
Django settings for pondeye project.
...
SECRET_KEY = '_l56au%#(zp$mzv(g4%)03z$i)!_(knfp!bi31%87*-w)rvrmb'
...
WSGI_APPLICATION = 'pondeye.wsgi.application'
